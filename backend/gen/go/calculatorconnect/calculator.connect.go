...
type CalculatorServiceClient interface {
	Calculate(context.Context, *connect_go.Request[gen.CalculationRequest]) (*connect_go.Response[gen.CalculationResponse], error)
}
...
func NewCalculatorServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) CalculatorServiceClient {
	...
	return &calculatorServiceClient{
		calculate: connect_go.NewClient[gen.CalculationRequest, gen.CalculationResponse](
			httpClient,
...
type calculatorServiceClient struct {
	calculate *connect_go.Client[gen.CalculationRequest, gen.CalculationResponse]
}

// Calculate calls calculator.v1.CalculatorService.Calculate.
func (c *calculatorServiceClient) Calculate(ctx context.Context, req *connect_go.Request[gen.CalculationRequest]) (*connect_go.Response[gen.CalculationResponse], error) {
...
func (UnimplementedCalculatorServiceHandler) Calculate(context.Context, *connect_go.Request[gen.CalculationRequest]) (*connect_go.Response[gen.CalculationResponse], error) {
